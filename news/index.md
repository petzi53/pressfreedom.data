...
- De-duplicated README.md and
  [`vignette("getting-started")`](https://petzi53.github.io/pressfreedom.data/articles/getting-started.md):
...
- The ETL/update functions are no longer part of the public API:
  ...
  [`clean_all_rwb_years()`](https://petzi53.github.io/pressfreedom.data/reference/clean_all_rwb_years.md),
  [`combine_cleaned_periods()`](https://petzi53.github.io/pressfreedom.data/reference/combine_cleaned_periods.md),
  [`consolidate_and_standardize_countries()`](https://petzi53.github.io/pressfreedom.data/reference/consolidate_and_standardize_countries.md),
  [`standardize_rwb_countries()`](https://petzi53.github.io/pressfreedom.data/reference/standardize_rwb_countries.md),
  [`update_rwb_data()`](https://petzi53.github.io/pressfreedom.data/reference/update_rwb_data.md),
  and its S3 print method
  [`print.rwb_update()`](https://petzi53.github.io/pressfreedom.data/reference/print.rwb_update.md)
  ...
  [`clean_period_1()`](https://petzi53.github.io/pressfreedom.data/reference/clean_period_1.md),
  [`clean_period_2()`](https://petzi53.github.io/pressfreedom.data/reference/clean_period_2.md),
  [`clean_period_3()`](https://petzi53.github.io/pressfreedom.data/reference/clean_period_3.md),
  [`convert_factors_to_character()`](https://petzi53.github.io/pressfreedom.data/reference/convert_factors_to_character.md),
  [`detect_csv_encoding()`](https://petzi53.github.io/pressfreedom.data/reference/detect_csv_encoding.md),
  [`detect_score_column()`](https://petzi53.github.io/pressfreedom.data/reference/detect_score_column.md),
  [`get_period()`](https://petzi53.github.io/pressfreedom.data/reference/get_period.md),
  [`get_period_encoding()`](https://petzi53.github.io/pressfreedom.data/reference/get_period_encoding.md),
  [`get_years_to_download()`](https://petzi53.github.io/pressfreedom.data/reference/get_years_to_download.md),
  [`normalize_column_names()`](https://petzi53.github.io/pressfreedom.data/reference/normalize_column_names.md),
  [`resolve_percent_scaling()`](https://petzi53.github.io/pressfreedom.data/reference/resolve_percent_scaling.md),
  and
  [`standardize_decimal_separators()`](https://petzi53.github.io/pressfreedom.data/reference/standardize_decimal_separators.md).
  [`validate_standardization()`](https://petzi53.github.io/pressfreedom.data/reference/validate_standardization.md)
