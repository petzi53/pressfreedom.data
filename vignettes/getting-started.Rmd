...
**A:** Please cite both the package and the original data source:
...
"pressfreedom.data")`. 
- Full function documentation will be available on the
package website, <https://www.peter-baumgartner.net/pressfreedom.data> (once
published); until then, use `?function_name` in R or browse the README on
GitHub.
